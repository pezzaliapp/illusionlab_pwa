(function () {
  ...
  const applyTheme=()=>{ root.classList.toggle("light", theme==="light"); btnTheme.textContent=theme==="light"?"🌙":"☀️"; };
  applyTheme();
  ...
  const i18n={
    it:{introText:"Regole: 10 illusioni (immagini Wikimedia corrette), visibilità massima su fondo bianco. Funziona offline per l'interfaccia.",start:"Inizia",leaderboard:"Classifica",showProof:"Mostra prova",explain:"Spiegazione",next:"Avanti ▶",endTitle:"🎉 Fine partita",saveScore:"Salva punteggio",playAgain:"Rigioca",boardTitle:"🏆 Classifica locale",name:"Nome",pts:"Punti",time:"Tempo",date:"Data",close:"Chiudi",askName:"Il tuo nome (o iniziali) per la classifica:",saved:"Salvato!",credits:"Crediti"},
    en:{introText:"Rules: 10 illusions (correct Wikimedia images), maximum visibility on white background. Offline-ready app shell.",start:"Start",leaderboard:"Leaderboard",showProof:"Show proof",explain:"Explanation",next:"Next ▶",endTitle:"🎉 Game over",saveScore:"Save score",playAgain:"Play again",boardTitle:"🏆 Local leaderboard",name:"Name",pts:"Pts",time:"Time",date:"Date",close:"Close",askName:"Your name (or initials) for the board:",saved:"Saved!",credits:"Credits"}
  };
  const T=k=>(i18n[lang]&&i18n[lang][k])||k;
  const applyI18n=()=>{ document.querySelectorAll("[data-i18n]").forEach(el=> el.textContent=T(el.getAttribute("data-i18n"))); btnCredits.textContent=T("credits"); };
  applyI18n();
  ...
  // Wikimedia image URLs (canonical)
  const IMG = {
  ...
  const CREDITS=[
    {id:"blivet",title:"Blivet — Wikimedia Commons",url:IMG.blivet},
    {id:"necker",title:"Necker's cube — Wikimedia Commons",url:IMG.necker},
    {id:"penroseTri",title:"Penrose triangle — Wikimedia Commons",url:IMG.penroseTri},
    {id:"penroseStair",title:"Penrose stairs — Wikimedia Commons",url:IMG.penroseStair},
    {id:"ames",title:"Ames room — Wikimedia Commons",url:IMG.ames},
    {id:"rubin",title:"Rubin's vase — Wikimedia Commons",url:IMG.rubin},
    {id:"duckRabbit",title:"Duck–Rabbit — Wikimedia Commons",url:IMG.duckRabbit},
    {id:"kanizsa",title:"Kanizsa triangle — Wikimedia Commons",url:IMG.kanizsa},
    {id:"mullerLyer",title:"Müller–Lyer — Wikimedia Commons",url:IMG.mullerLyer},
    {id:"fraser",title:"Fraser spiral — Wikimedia Commons",url:IMG.fraser},
  ];
  ...
  function startTimer(){ clearInterval(timer); tLeft=TIME_LIMIT; timerEl.textContent="⏱ "+tLeft+"s";
